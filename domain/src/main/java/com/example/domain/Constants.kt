...
const val COUNT_OF_COUNTRIES = 249
...
//my location map
const val MY_LOCATION_ZOOM = 5f
const val REQUEST_CODE = 1

//Location
const val DEFAULT_LATITUDE = -34.397
const val DEFAULT_LONGITUDE = 150.644
...
//interactor
const val HALF_MINUTE_MILLIS = 30000
const val DEFAULT_VALUE_LONG = 0L

//sliders
const val SLIDERS_KEY = "sliders_key"
const val FILTER_KEY = "filter_key"
const val ONE_KILOMETER = 1000
const val EQUATOR_LENGTH_FLOAT = 40075.0F

//bottom sheet dialogue
const val SETTINGS_KEY = "setting_key"
